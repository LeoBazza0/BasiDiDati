...
function getColumnsInformation($connection, $tableName)
{
    ...
    try {
        ...
        memorizeError("Lettura dal Database", $e->getMessage()); //The getMessage() method returns a description of the error or behaviour that caused the exception to be thrown
        header("Refresh:0");
    }
}
