...
function getStandardInputFields($connection, &$columns, $disabledFields = NULL, $valuesForFields = NULL) //plurale 
{
    $formFields = array();
...
function getReferentialInputFields($connection, &$columns, $foreignKeys, $disabledFields = NULL, $valuesForFields = NULL) //plurale 
{
    $formFields = array();
...
function getStandardInputField($connection, $column_data, $editable = true, $value = NULL) //singolare 
{
...
function getReferentialInputField($connection, &$columns, $foreignKeys, $referencedTable, &$index, $toedit = true, $valuesForFields = NULL) //singolare
{
