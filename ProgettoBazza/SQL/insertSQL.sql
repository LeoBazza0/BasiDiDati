...
INSERT INTO UtenzaPersonale (Personale, HashedPassword) VALUES 
('VRDLGU80B20H501Y', '$2y$10$/grW.BeNby.FmwHC6RA/VesJN6VgbLjCgiivVnyeIA4K2bcY547sW'), --Password: abcd
('BNCLNN85C25H501X', '$2y$10$/grW.BeNby.FmwHC6RA/VesJN6VgbLjCgiivVnyeIA4K2bcY547sW'), --Password: abcd
('NRIMRA90D30H501A', '$2y$10$/grW.BeNby.FmwHC6RA/VesJN6VgbLjCgiivVnyeIA4K2bcY547sW'), --Password: abcd
('RSSMRA75A15H501Z', '$2y$10$/grW.BeNby.FmwHC6RA/VesJN6VgbLjCgiivVnyeIA4K2bcY547sW'), --Password: abcd
('RSSCRL82E10H501B', '$2y$10$/grW.BeNby.FmwHC6RA/VesJN6VgbLjCgiivVnyeIA4K2bcY547sW'); --Password: abcd
...
('CSTMRM80A01H501H', 'CNTFNC78L14H501K', '2024-05-03', NULL);
...
('GRMLRA75H01H501Z', 'ES001', '2024-05-01', '08:30:00', 'LAB01', '2024-05-01', 'Rosso', FALSE, NULL),
('VRDGNN85C01H501P', 'ES002', '2024-05-02', '10:15:00', 'LAB02', '2024-05-02', 'Giallo', FALSE, NULL),
('RSTPPL92H01H501T', 'ES010', '2024-05-03', '12:45:00', 'LAB09', '2024-05-03', 'Verde', TRUE, NULL),
('NVRLUI85L01H501M', 'ES019', '2024-05-04', '14:30:00', 'LAB08', '2024-05-04', 'Rosso', FALSE, NULL),
('BNCLUI90L01H501Y', 'ES004', '2024-05-01', '08:30:00', 'LAB03', '2024-05-01', 'Rosso', TRUE, 'BNCLRA85D07H501J'),
('VRDGNN85C01H501P', 'ES005', '2024-05-12', '10:15:00', 'LAB04', '2024-05-02', 'Giallo', FALSE, 'MLTLUC81B17H501M'),
...
('RSSMRA85M01H501Z', 'ES007', '2024-08-08', '16:00:00', 'LAB05', '2024-05-05', 'Giallo', TRUE, 'FRNMRZ88D09H501N'),
