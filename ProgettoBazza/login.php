        ...
        <div class="card mt-5 border-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded container text-center">
            <div class="row">
                ...
                <form class=" col-8 text-start " method="POST" action="opmanager.php">
                    ...
                    <!-- nome -->
                    <?php echo buildInputText("Username", 0, 16, true); ?> 

                    <!-- password -->
                    <?php echo buildInputPassword("Password", 0, 255, true); ?>

                    <div class="d-flex justify-content-center me-4">
                        <button type="submit" class="btn btn-1 border-2 m-4 rounded-pill fw-bold" style="position: absolute; right: 0; bottom: 0; color:rgb(255, 255, 255); ">
                            Login
                        </button>
                    </div>                
                </form>
